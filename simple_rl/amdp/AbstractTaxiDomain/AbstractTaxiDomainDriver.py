...
from simple_rl.amdp.AbstractTaxiDomain.AbstractTaxiPolicyGenerators import L0PolicyGenerator, L1PolicyGenerator
...
if __name__ == '__main__':
    ...
    l1tf = l1_domain.terminal_func
    l1rf = l1_domain.reward_func
    ...
    l0_state = l0_domain.init_state
    l1_state = l1_policy_generator.generateAbstractState(l0_state)
