...
if __name__ == '__main__':
    ...
    formula_set1 = ['Fa', 'F (a & F b)',  'F(a & F( b & Fc))', '~a U b', 'F (a & F b)']
    ap_maps_set1 = {}
    ...
    # define scenarios for a large environment
    formula_set2 = ['Fa', 'Fa', 'F (a & F b)', '~a U b', 'F(a & F( b & Fc))']
    ap_maps_set2 = {}
    ap_maps_set2[0] = {'a': [1, 'state', 8]}
    ap_maps_set2[1] = {'a': [2, 'state', 6]}
    ap_maps_set2[2] = {'a': [2, 'state', 4], 'b': [1, 'state', 6]}
    ap_maps_set2[3] = {'a': [2, 'state', 4], 'b': [1, 'state', 6]}
    ap_maps_set2[4] = {'a': [1, 'state', 9], 'b': [2, 'state', 3], 'c': [1, 'state', 18]}
    ...
    # simulation settings
    run_num = 10.0   #the number of run
    flag_verbose = False  # Show result paths
    flag_save = True
    num_env = 2 #environment name : build_cube_env(num_env).py 3: for examples
